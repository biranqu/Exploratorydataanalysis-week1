...
with(filtData, plot(Date.Time, Global_active_power,  ylab = 'Global active power', type = 'l'))
with(filtData, plot(Date.Time, Voltage,  ylab = 'Voltage', xlab = 'datetime', type = 'l'))
...
with(filtData, plot(Date.Time, Global_reactive_power,  ylab = 'Global_reactive_power', xlab = 'datetime', type = 'l'))
dev.off()